...
$app->get("/boleto/:idorder", function($idorder){
	...
	$dadosboleto["demonstrativo1"] = "Pagamento de Compra na Loja Teste E-commerce";
	...
	$dadosboleto["instrucoes4"] = "&nbsp; Emitido pelo sistema Projeto Loja Teste E-commerce";
	...
	// SEUS DADOS
	$dadosboleto["identificacao"] = "Empresa de Teste";
	$dadosboleto["cpf_cnpj"] = "01.001.010/0001-01";
	$dadosboleto["endereco"] = "Rua Teste, 001 - São Paulo, 00000-100";
	$dadosboleto["cidade_uf"] = "São Paulo - SP";
	$dadosboleto["cedente"] = "Empresa de Teste LTDA";
