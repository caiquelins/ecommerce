                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo formatAddressUtf8($value1["desaddress"]); ?>, <?php echo formatDistrictUtf8($value1["desdistrict"]); ?>, <?php echo formatCityUtf8($value1["descity"]); ?> - , <?php echo htmlspecialchars( $value1["desstate"], ENT_COMPAT, 'UTF-8', FALSE ); ?> CEP: <?php echo htmlspecialchars( $value1["deszipcode"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
